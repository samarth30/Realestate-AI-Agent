...
class DirectionsInput(BaseModel):
    origin: str = Field(...,
                        description="The starting point address or coordinates")
...
class GeocodingTool(BaseTool):
    name: str = "geocoding"
    description: str = "Useful for getting latitude and longitude coordinates for an address"
...
class DirectionsTool(BaseTool):
    ...
    description: str = "Useful for finding travel distances and directions between two locations."
    args_schema: type = DirectionsInput
